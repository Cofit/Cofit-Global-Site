    ...
    <section ref={sectionRef} className="relative py-32 bg-white">
      <div className="max-w-7xl mx-auto px-8">
        ...
        <div className="grid grid-cols-3 gap-8 mb-20 max-md:grid-cols-1">
          {[
            { value: 12, suffix: "kg", label: "Average weight loss in 3 months", color: "#169E6B" },
            { value: 85, suffix: "%", label: "Improved blood sugar levels", color: "#004F51" },
            { value: 50, suffix: "K+", label: "Lives transformed across Asia", color: "#00C2E0" },
          ].map((stat, index) => (
            <motion.div
              key={index}
